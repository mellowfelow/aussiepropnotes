...
import { SITE, CATEGORIES, PRODUCTS } from '../data/site.js'
    ...
    <footer className="footer">
      <div className="footer-main">
        <div className="footer-brand">
          ...
          <p><Email addr={SITE.email} /> · <a href={'https://wa.me/' + SITE.whatsapp} rel="nofollow noopener">WhatsApp</a></p>
          <SocialLinks />
        </div>
      ...
      <div className="chat-float">
        <a className="chat-btn chat-wa" href={'https://wa.me/' + SITE.whatsapp} aria-label="Chat on WhatsApp" rel="nofollow noopener" target="_blank">
